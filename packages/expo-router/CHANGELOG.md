...
- [android] Fix `Stack.Toolbar.Button` dead first-tap: skip the mount enter animation in `AnimatedItemContainer` so the touch target is active immediately on render.
